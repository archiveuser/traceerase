(() => {
  ...
  const ru = {
    ...
    'time.unit': 'с',
    'signal.initial': 'готов к проверке', 'signal.ready': '{count} источников готово', 'signal.detected': 'отправная точка задана', 'signal.none': 'не задана',
    ...
    'report.waiting': '// ожидание данных…', 'report.savePdf': 'Сохранить PDF', 'report.downloadCard': 'Скачать карточку',
    'report.nextTitle.one': 'след. Что делать дальше?', 'report.nextTitle.few': 'следа. Что делать дальше?', 'report.nextTitle.many': 'следов. Что делать дальше?',
    ...
    'stranger.target': 'Отправная точка', 'stranger.matches': 'Найдено / проверено', 'stranger.categories': 'Категории',
    ...
    'stranger.noMatches': 'прямых совпадений нет',
    ...
    'card.matches': 'Найдено / проверено', 'card.categories': 'Категории', 'card.review': 'Проверить сначала',
    ...
    'scan.doneFound.one': 'Найден {count} след. Теперь у тебя есть карта и понятная точка старта.',
    'scan.doneFound.few': 'Найдено {count} следа. Теперь у тебя есть карта и понятная точка старта.',
    'scan.doneFound.many': 'Найдено {count} следов. Теперь у тебя есть карта и понятная точка старта.',
  ...
  const en = {
    ...
    'report.save': 'Save report', 'report.savePdf': 'Save PDF', 'report.downloadCard': 'Download card',
    ...
    'time.unit': 's',
    'signal.initial': 'ready to scan', 'signal.ready': '{count} sources ready', 'signal.detected': 'starting point set', 'signal.none': 'not set',
    ...
    'report.waiting': '// waiting for data…',
    'report.nextTitle.one': 'trace. What now?', 'report.nextTitle.few': 'traces. What now?', 'report.nextTitle.many': 'traces. What now?',
    ...
    'stranger.target': 'Starting point', 'stranger.matches': 'Found / checked', 'stranger.categories': 'Categories',
    ...
    'stranger.noMatches': 'no direct matches',
    ...
    'card.matches': 'Found / checked', 'card.categories': 'Categories', 'card.review': 'Review first',
    ...
    'scan.doneFound.one': '{count} trace found. You now have a map and a clear place to start.',
    'scan.doneFound.few': '{count} traces found. You now have a map and a clear place to start.',
    'scan.doneFound.many': '{count} traces found. You now have a map and a clear place to start.',
